 ...
 *
 * @example
 * const composed = compose(functionA, functionB, ...functionN[])
 * @documentation {@link https://github.com/yobta/stores/tree/master/src/util/compose/index.md}
 */
export const compose: YobtaCompose = (...yobtas) => {
